...
- [📖 holla rails api ](#-holla-rails-api-)
...
# 📖 holla rails api <a name="about-project"></a>

**holla rails api** is a api that sent random greetings the the user
...
1. Open your terminal and navigate to the root directory of your back-end project.
2. "Set up Username and password information in the config/database.yml"
...
special thanks to [Microverse](https://www.microverse.org/) for providing us with the essential materials for this project.
...
This project is [MIT](https://github.com/Grandi0z/hello_react_api/blob/dev/LICENSE) licensed.
